...
const Signup = () => {
  ...
  const { name, email, password, confirmPassword, schoolName, classSection } = user
          ...
          <form onSubmit={onSubmit} className="space-y-6">
              ...
              <div className="relative">
                ...
                <Select
                  onValueChange={(value: string) => (
                    setUser({ ...user, schoolName: value }), fetchClasses(Number(value))
                  )}
                ...
                >
                  <SelectTrigger className="w-full pl-10">
                    <SelectValue placeholder="Select your school">
                      {(() => {
                        const name = schools.find((s: any) => s.id == user.schoolName)?.name
                        if (!name) return null
                        return name.length > 25 ? name.slice(0, 25).concat("...") : name
                      })()}
                    </SelectValue>
                  </SelectTrigger>
                  <SelectContent>
            ...
            {userType === "student" && (
              <div className="relative">
                ...
                <Select
                  onValueChange={(value: string) => setUser({ ...user, classSection: value })}
                  value={classSection}
                >
                  <SelectTrigger className="w-full pl-10">
            ...
            <div className="flex gap-2 mt-6">
              <Button
                ...
                className={`flex-1 py-2 px-4 rounded-md transition-colors ${userType === "admin"
              ...
              <Button
                ...
                className={`flex-1 py-2 px-4 rounded-md transition-colors ${userType === "teacher"
                    ? "bg-primary text-primary-foreground border border-border"
                    : "bg-transparent text-muted-foreground border border-border hover:bg-muted"
                  }`}
              >
